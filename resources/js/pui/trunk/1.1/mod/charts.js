 ...
 * ==NOTES:=============================================
 * v2.0.0(2013-11-22):
 *     采用highcharts3.0.7封装成图表组件，其api基本没有多大变动，增加了renderTo，
 *     以使渲染可以通过css选择器进行
 *     refer：
...
KISSY.add('mod/charts', function(S, Charts) {
    //单例模式
    //如果charts没有加载过，则加载，否则利用上次加载过的charts
    if(!PW.mod || !PW.mod.Charts){
        PW.namespace('mod.Charts');
        PW.mod.Charts = {
            version: '2.0',
            client: function(param){
                return new Charts(param);
            }
        };
    }
}, {
...
KISSY.add('charts/core', function(S) {
    var 
        $ = jQuery,
        MSG = {
            noContainer: '找不到需要绘图的节点'
        };

    function Charts(param){
        this.version = '2.0.0';
        this.instances = [];
        this._init(param);
    }
    S.augment(Charts, {
        _init: function(param){
            var 
                that = this,
                container = $(param.renderTo),
                ins;
            //如果找不到挂载节点
            if(!param || !param.renderTo || container.length < 1){
                S.log(MSG.noContainer, 'error', 'mod/charts');
                return;
            }
            //生成并返回highcharts对象
            //具体用法查highcharts api： http://api.highcharts.com/highcharts
            ins = container.highcharts(param).highcharts();
 ...
 */
KISSY.add('highcharts/core', function(S) {
    ...
    (function() {
        ...
        var UNDEFINED,
            ...
            hasSVG = !! doc.createElementNS && !! doc.createElementNS(SVG_NS, 'svg')
                .createSVGRect,
            hasBidiBug = isFirefox && parseInt(userAgent.split('Firefox/')[1], 10) < 4, // issue #38
            useCanVG = !hasSVG && !isIE && !! doc.createElement('canvas')
                .getContext,
            Renderer,
        ...
        function numberFormat(number, decimals, decPoint, thousandsSep) {
            var lang = defaultOptions.lang,
                ...
                c = decimals === -1 ?
                    (n.toString()
                    .split('.')[1] || '')
                    .length : // preserve decimals
                (isNaN(decimals = mathAbs(decimals)) ? 2 : decimals),
                d = decPoint === undefined ? lang.decimalPoint : decPoint,
                t = thousandsSep === undefined ? lang.thousandsSep : thousandsSep,
                s = n < 0 ? "-" : "",
                i = String(pInt(n = mathAbs(n)
                    .toFixed(c))),
        ...
        function pad(number, length) {
            ...
            return new Array((length || 2) + 1 - String(number)
                .length)
                .join(0) + number;
        }
        ...
        dateFormat = function(format, timestamp, capitalize) {
            ...
            var date = new Date(timestamp),
                ...
                replacements = extend({
                    ...
                    // Year
                    'y': fullYear.toString()
                        .substr(2, 2), // Two digits year, like 09 for 2009
            ...
            return capitalize ? format.substr(0, 1)
                .toUpperCase() + format.substr(1) : format;
        };
        ...
        function format(str, ctx) {
            ...
            while ((index = str.indexOf(splitter)) !== -1) {
                ...
                if (isInside) { // we're on the closing bracket looking back
                    ...
                    path = valueAndFormat.shift()
                        .split('.'); // get first and leave format
                    len = path.length;
                    val = ctx;
    ...
    */
            ...
            htmlUpdateTransform: function() {
                ...
                if (elem.tagName === 'SPAN') {
                    ...
                    if (currentTextTransform !== wrapper.cTT) { // do the calculations and DOM access only if properties changed
                        ...
                        // correct x and y
                        baseline = renderer.fontMetrics(elem.style.fontSize)
                            .b;
        ...
        SVGRenderer.prototype = {
            ...
            init: function(container, width, height, forExport) {
                ...
                renderer.defs = this.createElement('defs')
                    .add();
            ...
            image: function(src, x, y, width, height) {
                ...
                elemWrapper = this.createElement('image')
                    .attr(attribs);
            ...
            clipRect: function(x, y, width, height) {
                ...
                wrapper = this.rect(x, y, width, height, 0)
                    .add(clipPath);
                wrapper.id = id;
        ...
        if (!hasSVG && !useCanVG) {
            ...
            var VMLRendererExtension = { // inherit SVGRenderer
                ...
                path: function(path) {
                    ...
                    // create the shape
                    return this.createElement('shape')
                        .attr(attr);
                },
        ...
        Axis.prototype = {
            ...
            addPlotBandOrLine: function(options, coll) {
                var obj = new PlotLineOrBand(this, options)
                    .render(),
            ...
            render: function() {
                ...
                if (hasData || isLinked) {
                    ...
                    if (tickPositions.length) { // #1300
                        each(tickPositions.slice(1)
                            .concat([tickPositions[0]]), function(pos, i) {
                    ...
                    if (!axis._addedPlotLB) { // only first time
                        each((options.plotLines || [])
                            .concat(options.plotBands || []), function(plotLineOptions) {
        ...
        Pointer.prototype = {
            ...
            setDOMEvents: function() {
                ...
                if (hasTouch) {
                    events.push(
                        [container, 'ontouchstart', 'onContainerTouchStart'], [container, 'ontouchmove', 'onContainerTouchMove'], [doc, 'touchend', 'onDocumentTouchEnd']
                    );
                }
        ...
        while (i--) {
            ...
            scroll: function(scrollBy, animation) {
                ...
                if (currentPage > 0) {
                    ...
                    this.down.attr({
                        x: 18 + this.pager.getBBox()
                            .width, // adjust to text width
            ...
            layOutTitles: function() {
                ...
                if (subtitle) {
                    ...
                    if (!subtitleOptions.floating && !subtitleOptions.verticalAlign) {
                        titleOffset = mathCeil(titleOffset + subtitle.getBBox()
                            .height);
                    }
                }
        ...
        Series.prototype = {
            ...
            drawLegendSymbol: function(legend) {
                ...
                var options = this.options,
                    ...
                    verticalCenter = legend.baseline - mathRound(renderer.fontMetrics(legendOptions.itemStyle.fontSize)
                        .b * 0.3),
                    attr;
                ...
                for (i = 0; i < processedDataLength; i++) {
                    ...
                    if (!hasGroupedData) {
                        ...
                        points[i] = (new pointClass())
                            .init(series, [processedXData[i]].concat(splat(processedYData[i])));
                    }
                }
        ...
        var PieSeries = {
            ...
            drawDataLabels: function() {
                ...
                while (!labelHeight && data[i]) { // #1569
                    labelHeight = data[i] && data[i].dataLabel && (data[i].dataLabel.getBBox()
                        ...
                        each(this.points, function(point) {
                            ...
                            if (dataLabel && dataLabel._pos) {
                                ...
                                if (connector) {
                                    ...
                                    point.connector = connector = series.chart.renderer.path(connectorPath)
                                        .attr({
...
KISSY.add('highcharts/more', function(S) {
    (function(Highcharts, UNDEFINED) {
        var arrayMin = Highcharts.arrayMin,
            ...
            defaultPlotOptions = Highcharts.getOptions()
                .plotOptions,
        ...
        extend(Pane.prototype, {
            ...
            init: function(options, chart, firstAxis) {
                ...
                if (backgroundOption) {
                    each([].concat(splat(backgroundOption))
                        .reverse(), function(config) {
        ...
        var radialAxisMixin = {
            ...
            getPlotBandPath: function(from, to, options) {
                ...
                if (this.options.gridLineInterpolation === 'polygon') {
                    ret = this.getPlotLinePath(from)
                        .concat(this.getPlotLinePath(to, true));
            ...
            getPlotLinePath: function(value, reverse) {
                ...
                if (axis.isCircular) {
                    ...
                    if (reverse) {
                        tickPositions = [].concat(tickPositions)
                            .reverse();
                    }
        ...
        wrap(tickProto, 'getLabelPosition', function(proceed, x, y, label, horiz, labelOptions, tickmarkOffset, index, step) {
            ...
            if (axis.isRadial) {
                ...
                if (labelOptions.rotation === 'auto') {
                    ...
                    optionsY = pInt(label.styles.lineHeight) * 0.9 - label.getBBox()
                        .height / 2;
...
KISSY.add('highcharts/exporting', function(S) {
