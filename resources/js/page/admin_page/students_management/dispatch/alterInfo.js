...
*   初始生成 
* ---------------------------------------------------------------------------*/
KISSY.add('page/admin_page/students_management/dispatch/alterInfo' , function(S,alterInfoShow,submit,suggest,image){
    PW.namespace('page.admin_page.students_management.dispatch.alterInfo');
    PW.page.admin_page.students_management.dispatch.alterInfo = function(param){
