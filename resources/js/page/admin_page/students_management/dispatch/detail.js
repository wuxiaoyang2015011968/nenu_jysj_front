...
* 	初始生成 
* ---------------------------------------------------------------------------*/
KISSY.add('page/admin_page/students_management/dispatch/detail',function(S,detail){
	PW.namespace('page.admin_page.students_management.dispatch.detail');
	PW.page.admin_page.students_management.dispatch.detail = function(){
		new detail();
	}
},{
...
KISSY.add('detail/detail',function(S){
	var 
		...
		that = this,
		DetailIO = PW.io.admin_page.students_management.dispatch.detail,
		el = {
	...
	requires:['event','io/admin_page/students_management/dispatch/detail','mod/dialog']
})
